...
token_str(PyTokenObject* self) {
    ...
    switch (self->type)
    {
        ...
        CLEX_LABELIZE(TOKEN_LEFT_PAREN);
        CLEX_LABELIZE(TOKEN_RIGHT_PAREN);
...
int
PyToken_Init(PyTokenObject* self, enum TokenType type, const char* literal, size_t size, int line)
{
